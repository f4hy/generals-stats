...
type MatchDetails struct {
	...
	UpgradeEvents map[string]*UpgradeEvent `protobuf:"bytes,4,rep,name=upgrade_events,json=upgradeEvents,proto3" json:"upgrade_events,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
...
func (x *MatchDetails) GetUpgradeEvents() map[string]*UpgradeEvent {
	if x != nil {
...
var file_proto_match_proto_rawDesc = []byte{
	...
	0x52, 0x0b, 0x75, 0x70, 0x67, 0x72, 0x61, 0x64, 0x65, 0x4e, 0x61, 0x6d, 0x65, 0x22, 0x9b, 0x02,
	...
	0x74, 0x73, 0x1a, 0x57, 0x0a, 0x12, 0x55, 0x70, 0x67, 0x72, 0x61, 0x64, 0x65, 0x45, 0x76, 0x65,
	...
	0x6c, 0x75, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x15, 0x2e, 0x6d, 0x61, 0x74, 0x63,
	0x68, 0x65, 0x73, 0x2e, 0x55, 0x70, 0x67, 0x72, 0x61, 0x64, 0x65, 0x45, 0x76, 0x65, 0x6e, 0x74,
	0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x2a, 0x89, 0x01, 0x0a, 0x07,
	...
	0x04, 0x44, 0x45, 0x4d, 0x4f, 0x10, 0x0b, 0x2a, 0x2f, 0x0a, 0x07, 0x46, 0x61, 0x63, 0x74, 0x69,
	0x6f, 0x6e, 0x12, 0x0a, 0x0a, 0x06, 0x41, 0x4e, 0x59, 0x55, 0x53, 0x41, 0x10, 0x00, 0x12, 0x0c,
	0x0a, 0x08, 0x41, 0x4e, 0x59, 0x43, 0x48, 0x49, 0x4e, 0x41, 0x10, 0x01, 0x12, 0x0a, 0x0a, 0x06,
	0x41, 0x4e, 0x59, 0x47, 0x4c, 0x41, 0x10, 0x02, 0x2a, 0x37, 0x0a, 0x04, 0x54, 0x65, 0x61, 0x6d,
	...
	0x66, 0x34, 0x68, 0x79, 0x2f, 0x67, 0x65, 0x6e, 0x65, 0x72, 0x61, 0x6c, 0x73, 0x73, 0x74, 0x61,
	0x74, 0x73, 0x3b, 0x67, 0x65, 0x6e, 0x65, 0x72, 0x61, 0x6c, 0x73, 0x73, 0x74, 0x61, 0x74, 0x73,
...
var file_proto_match_proto_msgTypes = make([]protoimpl.MessageInfo, 23)
var file_proto_match_proto_goTypes = []interface{}{
	...
	(*MatchDetails)(nil),          // 20: matches.MatchDetails
	(*PlayerStat_GeneralWL)(nil),  // 21: matches.PlayerStat.GeneralWL
	(*PlayerStat_FactionWL)(nil),  // 22: matches.PlayerStat.FactionWL
	(*GeneralStat_PlayerWL)(nil),  // 23: matches.GeneralStat.PlayerWL
	(*Costs_BuiltObject)(nil),     // 24: matches.Costs.BuiltObject
	nil,                           // 25: matches.MatchDetails.UpgradeEventsEntry
...
var file_proto_match_proto_depIdxs = []int32{
	...
	26, // 2: matches.MatchInfo.timestamp:type_name -> google.protobuf.Timestamp
	...
	21, // 6: matches.PlayerStat.stats:type_name -> matches.PlayerStat.GeneralWL
	22, // 7: matches.PlayerStat.faction_stats:type_name -> matches.PlayerStat.FactionWL
	...
	23, // 10: matches.GeneralStat.stats:type_name -> matches.GeneralStat.PlayerWL
	...
	24, // 19: matches.Costs.buildings:type_name -> matches.Costs.BuiltObject
	24, // 20: matches.Costs.units:type_name -> matches.Costs.BuiltObject
	17, // 21: matches.MatchDetails.costs:type_name -> matches.Costs
	18, // 22: matches.MatchDetails.apms:type_name -> matches.APM
	25, // 23: matches.MatchDetails.upgrade_events:type_name -> matches.MatchDetails.UpgradeEventsEntry
	0,  // 24: matches.PlayerStat.GeneralWL.general:type_name -> matches.General
	6,  // 25: matches.PlayerStat.GeneralWL.win_loss:type_name -> matches.WinLoss
	1,  // 26: matches.PlayerStat.FactionWL.faction:type_name -> matches.Faction
	6,  // 27: matches.PlayerStat.FactionWL.win_loss:type_name -> matches.WinLoss
	6,  // 28: matches.GeneralStat.PlayerWL.win_loss:type_name -> matches.WinLoss
	19, // 29: matches.MatchDetails.UpgradeEventsEntry.value:type_name -> matches.UpgradeEvent
